...
def get_seekers(location: str, input_file: str, output_file: str):
...
if __name__:
    ...
    add_seeker("vlanger_final_project/seekers.txt")
    get_seekers(location="remote",
                input_file="vlanger_final_project/seekers.txt",
                output_file="vlanger_final_project/output.txt")
